...
<div class="row">
  <div class="col-lg-12 d-flex align-items-stretch">
    <div class="card w-100">
      <form class="card-body p-4" id="form" action="{{url('product')}}" method="post" enctype="multipart/form-data">
          @csrf
        <div class="d-flex justify-content-between align-items-center">
          <h2 class="fw-semibold mb-4">Tambah Produk</h2>
        </div>
              ...
              <div class="form-group">
                ...
                <div class="image-upload-wrapper d-flex align-items-center justify-content-start">
                  ...
                  <div class="upload-box" onclick="document.getElementById('imageUpload').click()">
                    <img id="previewImage" src="https://placehold.co/600x400?text=Click+Here" class="img-fluid" alt="Upload Image">
                  </div>
                </div>
