...
<div class="row">
  <div class="col-lg-12 d-flex align-items-stretch">
    <div class="card w-100">
      <form class="card-body p-4" id="form" action="{{url('barang-keluar/' . $barang_keluar->id)}}" method="post">
          @csrf
          @method('PUT')
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="tgl_keluar" name="tgl_keluar" value="{{ date('Y-m-d', strtotime($barang_keluar->outbound_date)) }}">
              </div>
            </div>
            <div class="col-lg-4">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="customer" name="customer" value="{{ $barang_keluar->customer_name }}">
              </div>
            </div>
            <div class="col-lg-4">
              <div class="form-group">
          ...
          <table class="table text-nowrap mb-0 align-middle" id="table_detail">
                ...
                <tr>
                  ...
                  <td class="border-bottom-0">
                    <div class="d-flex gap-2 align-items-center justify-content-center">
                      ...
                      <input type="number" name="qty[]" class="form-control text-center" value="{{$item->quantity}}" max="{{$item->product->stock > $item->quantity ? $item->product->stock : $item->quantity}}">
                      <a href="javascript:void(0)" class="btn btn-primary" title="Tambah Qty" onclick="tambah(this)"><i class="ti ti-plus"></i></a>
                    </div>
                  </td>
                  <td class="border-bottom-0">
                    <input type="number" name="total[]" class="form-control" value="{{$item->price_per_unit ? ($item->$price_per_unit * $item->quantity) : ($item->product->sell_price * $item->quantity)}}">
                  </td>
                  <td class="border-bottom-0">
            ...
            <tfoot class=" pt-5">
              ...
              <tr>
                ...
                <td colspan="" class="border-bottom-0 p-0">
                  <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" @if ($barang_keluar->shipping_address != null) checked @endif>
                        
                    <label class="btn btn-outline-primary" for="btnradio1">Diambil</label>

                    <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off"  @if (!$barang_keluar->shipping_address) checked @endif>
              ...
              <tr class="d-none" id="shipping_address_row">
                ...
                <td colspan="" class="border-bottom-0 p-0"><textarea name="shipping_address" class="form-control border-1">{{$barang_keluar->shipping_address ?? ""}}</textarea></td>
              </tr>
              <tr class="d-none" id="shipping_fee_row">
                ...
                <td colspan="" class="border-bottom-0 p-0"><input type="number" id="shipping_fee" class="form-control fw-bold" name="shipping_fee" value="{{$barang_keluar->shipping_fee ?? ""}}"></td>
              </tr>
              <tr>
                <td colspan="4"></td>
              ...
              <tr>
                ...
                <td colspan="" class="border-bottom-0 p-0"><input type="number" id="discount" class="form-control" name="discount" value="{{$barang_keluar->discount}}"></td>
              </tr>
              <tr>
                <td colspan="4"></td>
                <td colspan="" class="text-start border-bottom-0 p-0"><h6 class="fw-semibold mb-0">Grand Total</h6></td>
                <td colspan="" class="border-bottom-0 p-0"><input type="number" id="grand_total" class="form-control border-0 fw-bold" name="total_payment" readonly value="{{$barang_keluar->total_payment ?? ""}}"></td>
              </tr>
              <tr>
                <td colspan="4"></td>
              ...
              <tr>
                ...
                <td colspan="" class="border-bottom-0 p-0"><textarea name="keterangan" class="form-control border-1">{{$barang_keluar->keterangan}}</textarea></td>
              </tr>
              {{-- save --}}
              <tr>
